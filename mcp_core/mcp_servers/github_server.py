...
@github_mcp.tool(description="Use this tool to Manage GitHub user/account info")
def github_user(
    action: str,
    username: str = None,
    visibility: str = "all"
...
@github_mcp.tool(description="Use this tool to Manage repository info.")
...
@github_mcp.tool(description="Use this tool to Manage branches in the authenticated user's GitHub repositories.")
def github_branch(
    action: str,
    owner: str = None,
    repo: str = None,
...
@github_mcp.tool(description="Use this tool to Manage files in a repo.")
def github_file(
    action: str,
    owner: str = None,
    repo: str = None,
...
@github_mcp.tool(description="Use this tool to View commit history and details.")
def github_commit(
    action: str,
    repo: str,
    branch: str = "master",
...
@github_mcp.tool(description="Use this tool to Manage GitHub issues.")
def github_issue(
    action: str,
    repo: str = None,
    number: int = None,
...
@github_mcp.tool(description="Use this tool to Manage GitHub pull requests.")
...
@github_mcp.tool(description="Use this tool to Search GitHub.")
def github_search(
    action:str,
    query:str=None,
    sort:str=None
...
@github_mcp.tool(description="Use this tool to Manage GitHub Actions workflows.")
def github_workflow(
    action: str,
    owner: str = None,
    repo: str = None,
